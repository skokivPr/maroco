...
window.addEventListener('load', function () {
    ...
    monaco.editor.defineTheme('terminal-dark', {
        ...
        rules: [
            ...
            // JSON
            { token: 'key', foreground: 'FED604', fontStyle: 'bold' },
            { token: 'string.key.json', foreground: 'FED604', fontStyle: 'bold' },
            { token: 'value', foreground: '21fd6b' },
            { token: 'string.value.json', foreground: '21fd6b' },
            { token: 'number.json', foreground: 'F39C12' },
            { token: 'number.hex.json', foreground: 'F39C12' },
            { token: 'number.float.json', foreground: 'F39C12' },
            { token: 'constant.language.json', foreground: 'a29bfe', fontStyle: 'bold' },
            { token: 'delimiter.json', foreground: 'e2e2e2ec' },
            { token: 'delimiter.bracket.json', foreground: 'e2e2e2ec' },
            { token: 'delimiter.comma.json', foreground: 'e2e2e2ec' },
    ...
    monaco.editor.defineTheme('terminal-light', {
        ...
        rules: [
            ...
            // JSON
            { token: 'key', foreground: '1a1a1a', fontStyle: 'bold' },
            { token: 'string.key.json', foreground: '1a1a1a', fontStyle: 'bold' },
            { token: 'value', foreground: '28a745' },
            { token: 'string.value.json', foreground: '28a745' },
            { token: 'number.json', foreground: 'fd810d' },
            { token: 'number.hex.json', foreground: 'fd810d' },
            { token: 'number.float.json', foreground: 'fd810d' },
            { token: 'constant.language.json', foreground: 'fd810d', fontStyle: 'bold' },
            { token: 'delimiter.json', foreground: '1a1a1a' },
